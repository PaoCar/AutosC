      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5">Datos de interes</h1>
          </div>
          <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
            <form>
              ...
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="text" class="form-control form-control-lg" placeholder="Ingrese el modelo">
                </div>
                <div class="col-12 col-md-3">
              ...
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="text" class="form-control form-control-lg" placeholder="Ingrese el color deseado">
                </div>
                <div class="col-12 col-md-3">
              ...
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="text" class="form-control form-control-lg" placeholder="Ingrese el presupuesto">
                </div>
                <div class="col-12 col-md-3">
                  <h3 class="mb-5">Rango de precios</h3>
                </div>
              </div>              
            </form>              
              <div>&nbsp</div>
